 ...
 * This client is used for storing study case along its all sample names
 */
public class StudyCaseSampleClient
{
    ...
    public static void main(String[] args) throws ParseException {
        ...
        */
        ...
        studyCaseDao.saveStudyCase(studyCase);  // persist the study case and its samples
    }
}
