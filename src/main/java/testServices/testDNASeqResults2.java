 ...
 */
public class testDNASeqResults2
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        */
        ...
        StudyCase studyCase = studyCaseDao.getStudyCaseById(4413L);
        List<Sample> samplesInThisStudy = new ArrayList<>(); // sampleDao.getSamplesByStudyCase(studyCase);

       // String fileName = "/Users/guoliangwang/Dropbox/java/Ninja/edu.ucdenver.cancercenter.PDTXCancerGenome/070_SNPs_filtered.csv";
        /****/
